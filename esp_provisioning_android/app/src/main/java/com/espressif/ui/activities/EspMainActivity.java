...
public class EspMainActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        ivEsp = findViewById(R.id.iv_esp);  //  layout content_exp_main.xml
        btnAddDevice = findViewById(R.id.btn_provision_device);
        btnAddDevice.findViewById(R.id.iv_arrow).setVisibility(View.GONE);  // Appears to recycle an arrow normally in top menu bar - so need to make it invisible in main area
    ...
    View.OnClickListener addDeviceBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            addDeviceClick();  // next formula below
        }
    };
